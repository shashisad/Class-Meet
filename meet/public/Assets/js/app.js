...
// -------------------------------SDP Process----------------------------
    ...
    $(document).on("click",".top-left-participant-wrap", function(){
        ...
        $(".in-call-wrap-up").show(200);
        $(".chat-show-wrap").hide(200);
     ...
     $(document).on("click",".top-left-chat-wrap", function(){
        $(".g-right-details-wrap").show(200);
        $(".in-call-wrap-up").hide(200);
        $(".chat-show-wrap").show(200);
   ...
   $(document).on("change", ".custom-file-input",function(){
    ...
    $(document).on("click", ".share-attach",function(e){
        ...
        var attachFilePath = "public/Assets/attachment/"+meetingid+"/"+attachFileName;
